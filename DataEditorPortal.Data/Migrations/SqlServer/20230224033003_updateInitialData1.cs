...
{
    public partial class updateInitialData1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                column: "QueryText",
                value: "SELECT dd.Label, dd.Value, dd.Value1, dd.Value2 FROM dep.DataDictionaries dd WHERE dd.Category = 'Employer' {{ AND dd.Value1 IN ##vendor## }} ORDER BY dd.Label");
            ...
            migrationBuilder.UpdateData(
                ...
                column: "QueryText",
                value: "SELECT sr.RoleName AS Label, sr.Id AS Value FROM dep.SiteRoles sr ORDER BY sr.RoleName");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("704a3d00-62df-4c62-a4bd-457c4dc242ca"),
                column: "QueryText",
                value: "SELECT dd.Label, dd.Value FROM dep.DataDictionaries dd WHERE dd.Category = 'Employer' ORDER BY dd.Label");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("727052ba-0033-42c9-a39c-06a103e4b021"),
                column: "QueryText",
                value: "SELECT sr.RoleName, sr.Id FROM dep.SiteRoles sr ORDER BY sr.RoleName");
