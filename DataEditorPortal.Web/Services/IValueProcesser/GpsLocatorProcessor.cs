...
namespace DataEditorPortal.Web.Services
{
    ...
    public class GPSLocatorProcessor : ValueProcessorBase
    {
        private readonly IServiceProvider _serviceProvider;

        public GPSLocatorProcessor(IServiceProvider serviceProvider)
        {
        ...
        private void ProcessGPSField(IDictionary<string, object> model)
        {
            if (Field.props == null) return;

            if (Field.filterType == "gpsLocatorField")
            {
                if (model.ContainsKey(Field.key))
                {
                    using (JsonDocument doc = JsonDocument.Parse(Field.props.ToString()))
    ...
    [FilterType("gpsLocatorField")]
    public class GPSLocatorComparer : ValueComparerBase
    {
