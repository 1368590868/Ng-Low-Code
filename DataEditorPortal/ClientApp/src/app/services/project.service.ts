...
export class ProjectService {
  ...
  saveData (data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Project/SaveData`, param).pipe(
      map(e => e as any)
    );
  ...
  addNewData (data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Project/AddNewData`, param).pipe(
      map(e => e as any)
    );
  ...
  checkNameExists(data: any) {
    ...
    return this.http.post<any>(`${this._apiUrl}Project/CheckNameExists`, param).pipe(
      map(e => e as any)
    );
  ...
  fetchData(searchParam?: any, gridParam?: any): any {
    ...
    return this.http.post<any>(`${this._apiUrl}Project/FetchData`, fetchParam).pipe(
      map(e => e as any)
    );
  }
  ...
  exportData(exportData: any, cols: any[], searchParam?: any, gridParam?: any)
  {
    ...
    return this.http.post(`${this._apiUrl}Project/ExportData`, fetchParam, { responseType: 'blob'}).pipe(
      map(e => e as any)
    );
  }  
}
