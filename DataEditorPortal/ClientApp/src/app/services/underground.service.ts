...
export class UndergroundService {
  ...
  fetchDetailData(id: string, state: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Underground/FetchDetailData?id=` + id + '&state=' + state).pipe(
      map(e => e as any)
    );
  ...
  fetchHoldData(id: string, state: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Underground/FetchOnHoldData?id=` + id + '&state=' + state).pipe(
      map(e => e as any)
    );
  ...
  fetchDataSingle(id: string, state: string)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Underground/FetchDataSingle`, fetchParam).pipe(
      map(e => e as any)
    );
  }
  fetchData(searchParam?: any, gridParam?: any): any {
    ...
    return this.http.post<any>(`${this._apiUrl}Underground/FetchData`, fetchParam).pipe(
      map(e => e as any)
    );
  }
  ...
  {
    return this.http.post<any>(`${this._apiUrl}Underground/DeleteAttachment`, data).pipe(
      map(e => e as any)
    );
  ...
  {
    return this.http.post(`${this._apiUrl}Underground/GetAttachmentFile`, data, { responseType: 'blob'}).pipe(
      map(e => e as any)
    );
  ...
  {
    return this.http.post(`${this._apiUrl}Underground/GetTempAttachmentFile`, data, { responseType: 'blob'}).pipe(
      map(e => e as any)
    );
  ...
  {
    return this.http.post<any>(`${this._apiUrl}Underground/RestoreAttachment`, data).pipe(
      map(e => e as any)
    );
  ...
  fetchAttachmentData(id: string, state: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Underground/FetchAttachmentData?id=` + id + '&state=' + state).pipe(
      map(e => e as any)
    );
  ...
  fetchTransactionData(id: string, state: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Underground/FetchTransactionData?id=` + id + '&state=' + state).pipe(
      map(e => e as any)
    );
  ...
  validateBatch(id: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Underground/ValidateBatch?id=` + id).pipe(
      map(e => e as any)
    );
  ...
  saveData (data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Underground/SaveData`, param).pipe(
      map(e => e as any)
    );
  ...
  deleteData(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Underground/DeleteData`, param).pipe(
      map(e => e as any)
    );
  }
  ...
  validateWorkOrder(id: string, state: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Underground/ValidateWorkOrder?id=` + id + '&state=' + state).pipe(
      map(e => e as any)
    );
  ...
  addNewData (data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Underground/AddNewData`, param).pipe(
      map(e => e as any)
    );
  ...
  fetchComments(orderNumber: string, workOrderState: string)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Underground/FetchComments`, param).pipe(
      map(e => e as any)
    );
