...
export class LandBaseService {
  ...
  fetchDetailData(id: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Landbase/FetchDetailData?id=` + id).pipe(
      map(e => e as any)
    );
  ...
  fetchDataSingle(id: string, state: string)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/FetchDataSingle`, fetchParam).pipe(
      map(e => e as any)
    );
  }
  ...
  {
    return this.http.post(`${this._apiUrl}Landbase/GetAttachmentFile`, data, { responseType: 'blob'}).pipe(
      map(e => e as any)
    );
  ...
  {
    return this.http.post(`${this._apiUrl}Landbase/GetTempAttachmentFile`, data, { responseType: 'blob'}).pipe(
      map(e => e as any)
    );
  ...
  fetchData(searchParam?: any, gridParam?: any): any {
    ...
    if (!this.user.Permissions.LANDBASE_VIEW_ALL && this.user.Permissions.LANDBASE_VIEW_VENDOR_ONLY)
    {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/FetchData`, fetchParam).pipe(
      map(e => e as any)
    );
  }
  ...
  fetchAttachmentData(id: string, state: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Landbase/FetchAttachmentData?id=` + id + '&state=' + state).pipe(
      map(e => e as any)
    );
  ...
  {
    return this.http.post<any>(`${this._apiUrl}Landbase/DeleteAttachment`, data).pipe(
      map(e => e as any)
    );
  ...
  {
    return this.http.post<any>(`${this._apiUrl}Landbase/RestoreAttachment`, data).pipe(
      map(e => e as any)
    );
  ...
  fetchTransactionData(id: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Landbase/FetchTransactionData?id=` + id).pipe(
      map(e => e as any)
    );
  ...
  validateBatch(id: string)
  {
    ...
    return this.http.get(`${this._apiUrl}Landbase/ValidateBatch?id=` + id).pipe(
      map(e => e as any)
    );
  ...
  assignWorkOrder(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/AssignWorkOrder`, param).pipe(
      map(e => e as any)
    );
  ...
  completeWorkOrder(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/CompleteWorkOrder`, param).pipe(
      map(e => e as any)
    );
  ...
  problemWorkOrder(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/ProblemWorkOrder`, param).pipe(
      map(e => e as any)
    );
  ...
  closedProblemWorkOrder(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/ClosedProblemWorkOrder`, param).pipe(
      map(e => e as any)
    );
  ...
  CNFAWorkOrder(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/CNFAWorkOrder`, param).pipe(
      map(e => e as any)
    );
  ...
  sentReceivedBackWorkOrder(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/SentReceivedBackWorkOrder`, param).pipe(
      map(e => e as any)
    );
  ...
  saveData (data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/SaveData`, param).pipe(
      map(e => e as any)
    );
  ...
  deleteData(data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/DeleteData`, param).pipe(
      map(e => e as any)
    );
  }
  ...
  addNewData (data: any)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/AddNewData`, param).pipe(
      map(e => e as any)
    );
  ...
  fetchComments(orderNumber: string, workOrderState: string)
  {
    ...
    return this.http.post<any>(`${this._apiUrl}Landbase/FetchComments`, param).pipe(
      map(e => e as any)
    );
